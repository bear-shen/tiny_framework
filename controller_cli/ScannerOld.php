...
//                var_dump($postList);
                    ...
                    return;
                    SpdScanOld::writeThreads($result['thread']);
//				var_dump($scanData['post']);
                    SpdScanOld::writePost($result['post']);
                    SpdScanOld::writePost($result['comment']);
                    echo '=== scan finished ===' . "\n";
                    //
