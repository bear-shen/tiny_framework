    ...
    public function Scan() {
        ...
        go(function () {
            try {
                //
                self::tick();
                self::line('swoole initial');
                \Swlib\SaberGM::default(
                    [
                        'exception_report' => 0,
                        'max_coroutine'    => 8191,
                    ]);
                SpdScan::$cookie = Settings::get('cookie');
                SpdScan::$header = Settings::get('header');
                //=================
                $tidList = SpdScan::getTid();
                /*	$tidList  = [
                        '5739033322',
                        '4824528997',
                        '5948504167',
                ...
                $postList = SpdScan::getPost($tidList);
                /*$postList['thread'] = [
                    [
                        'fid'         => '52',
                        'tid'         => '5739033322',
                ...
                $comment = [];
//		$comment = self::getComment($postList['thread']);
                $result = [
                    'tid'     => $tidList,
